...
func TestVerifySwitchSampleReport(t *testing.T) {
	result, err := VerifySwitchFilesWithOptions(
	...
	if err != nil {
		t.Fatalf("VerifySwitchFilesWithOptions() error = %v", err)
	}
...
func TestVerifySwitchSerializedEvidenceSingle(t *testing.T) {
	result, err := VerifySwitchSerializedEvidenceFileWithOptions(
	...
	if err != nil {
		t.Fatalf("VerifySwitchSerializedEvidenceFileWithOptions() error = %v", err)
	}
	if !result.CertChainVerified || !result.ReportSignatureVerified || !result.NonceMatches {
		t.Fatalf("unexpected result: %+v", result)
	}
...
func TestVerifySwitchSerializedEvidenceAll(t *testing.T) {
	items, err := VerifySwitchSerializedEvidenceAllFileWithOptions(
	...
	if err != nil {
		t.Fatalf("VerifySwitchSerializedEvidenceAllFileWithOptions() error = %v", err)
	}
	if got, want := len(items), 4; got != want {
		t.Fatalf("len(items) = %d, want %d", got, want)
	}
...
func TestVerifySwitchSampleReportWithLocalRIM(t *testing.T) {
	...
	if err != nil {
		t.Fatalf("VerifySwitchFilesWithOptions(RIM) error = %v", err)
	}
